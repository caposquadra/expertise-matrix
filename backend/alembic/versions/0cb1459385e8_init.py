...
def upgrade() -> None:
    ...
    sa.Column('grade', sa.Enum('junior', 'middle', 'senior', name='employee_grade'), nullable=True),
    ...
    op.create_table('ipr_plans',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('employee_id', sa.UUID(), nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('draft', 'active', 'completed', 'cancelled', name='ipr_status'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'in_progress', 'achieved', 'overdue', name='goal_status'), nullable=False),
